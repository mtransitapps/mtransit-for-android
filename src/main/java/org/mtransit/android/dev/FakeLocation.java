...
public final class FakeLocation {
	...
	public static Location getLocation() {
		...
		// return LocationUtils.getNewLocation(46.118697, -74.593228, 77F); // DEBUG (L'Inter des Laurentides)
		...
		// return LocationUtils.getNewLocation(43.466476, -80.532906, 77F); // DEBUG (Waterloo - GRT)
