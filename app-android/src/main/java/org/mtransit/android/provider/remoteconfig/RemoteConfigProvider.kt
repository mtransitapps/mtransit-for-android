...
class RemoteConfigProvider @Inject constructor(
    ...
    companion object {
        ...
        const val PEACEFUL_FIRST_APP_EXP = "mt_peace_first_app_exp"
        const val PEACEFUL_FIRST_APP_EXP_DEFAULT = false
        // const val PEACEFUL_FIRST_APP_EXP_DEFAULT = true // DEBUG
    }
